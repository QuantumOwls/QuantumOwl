...
<body>
    ...
    <nav class="navigation">
        ...
        <!--Menu-->
        <ul class="menu" id = "navigation-bar">
            <li><a href="../index.html" class="nav_links">Home</a></li>
            <li><a href="game_page/game.php" class="nav_links">Game</a></li>
            <li><a href="#" class="nav_links">Rules</a></li>
            <li><a href="#" class="nav_links">Tips & Tricks</a></li>
